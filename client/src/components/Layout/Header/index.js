...
const Header = () => {
  ...
  const iconNavbar = !isShowNavbarMobile ? (
    <List onClick={handleClickNavbarIcon} style={{ cursor: "pointer" }} />
  ) : (
    <Close onClick={handleClickCloseNavbar} style={{ cursor: "pointer" }} />
  );
  return (
    <header>
      <Container fixed maxWidth="lg">
        <div className={classes.header}>
          ...
          <Box className={classes.logo}>
            ...
            <Modal
              isShowNavbarMobile={isShowNavbarMobile}
              onClickHideNavbarMobile={handleClickHideNavbarMobile}
            />
          </Box>
